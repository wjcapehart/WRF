 ...
 errflg = 0
       ...
       if((qcxl(i,k)+qixl(i,k)).gt.0.01e-3.and.ysu_topdown_pblmix)then
           if ( kpbl(i) .ge. 2) then
                ...
                do kk = 1,kpbl(i)-1
                   ...
                   radflux=radflux*cp/g*(p2di(i,kk)-p2di(i,kk+1)) 
   ...
   enddo
      ...
      real(kind=kind_phys) :: delt_thv   
      real(kind=kind_phys), parameter :: sbl_lim  = 200. 
      real(kind=kind_phys), parameter :: sbl_damp = 400. 
